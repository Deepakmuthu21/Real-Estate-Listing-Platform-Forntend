...
useEffect(() => {
  ...
  const fetchData = async () => {
    await axios
      .get(`https://real-estate-listing-platform-backend-1.onrender.com/api/product/getproductdetail/${userid}`)
...
const handleDelete = async (id)=>{
  await axios.delete(`https://real-estate-listing-platform-backend-1.onrender.com/api/product/delete-product/${id}`)
